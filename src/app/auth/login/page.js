  ...
  return (
    <div className="relative mt-8 mx-auto flex flex-col gap-2 w-[375px]">
      ...
      <label
        htmlFor="signup"
        title="Registro"
        className='absolute right-0 text-slate-500 peer-checked/register:text-black'>
        <CirclePlus />
      </label>
      ...
      <label
        htmlFor="signin"
        title="Iniciar sesión"
        className='absolute right-10 text-slate-500 peer-checked/login:text-black'>
        <Play />
      </label>
      ...
      <label
        ...
        className='absolute right-20 text-slate-500 peer-checked/oauth:text-black'>
        <Globe />
      </label>
